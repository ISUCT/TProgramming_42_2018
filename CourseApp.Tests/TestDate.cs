...
namespace CourseApp.Tests
{
    public class TestDate
    {
        ...
        public void TestDate20070909()
        {
            ...
            Assert.Equal(@"Year: 11  Month: 05  Day: 27 ", birthday.Age(age));
        }
        ...
        public void TestDate19800515()
        {
            ...
            Assert.Equal(@"Year: 38  Month: 09  Day: 20 ", birthday.Age(age));
        }
        ...
        public void TestDate19300307()
        {
            ...
            Assert.Equal(@"Year: 88  Month: 11  Day: 28 ", birthday.Age(age));
        }
    }
}