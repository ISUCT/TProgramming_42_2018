...
", admiral.Ris());
        ...
        {
            Ship admiral = new Ship();
            Assert.Equal($"Êîðàáëü {admiral.Name} âûøåë â îòêðûòîå ìîðå", admiral.Predlojenie());
        }
        ...
        public void AdmiralISwim()
        {
            ...
            Assert.Equal($"Êîðàáëü Admiral îñòàíîâèëñÿ ó ïðè÷àëà", iswim);
        }
        ...
        public void LuckyISwim()
        {
            ...
            Assert.Equal($"Êîðàáëü Lucky îñòàíîâèëñÿ ó ïðè÷àëà", iswim);
        }
    }
}